...
async function POST(request) {
     ...
     * ============================================================
     */ const { data: rules, error: rulesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$winfixer$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('diagnostic_rules').select('*').eq('context_id', session.context_id).eq('status', 'published').order('priority', {
            ascending: true
        });
        if (rulesError) {
        ...
        console.log('DIAGNOSTIC RULES:', rules);
        /*
     * ============================================================
     ...
     * 7. BUSCAR FIX
     * ============================================================
     */ const { data: fix, error: fixError } = await __TURBOPACK__imported__module__$5b$project$5d2f$winfixer$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('fixes').select('*').eq('id', matchedRule.fix_id).eq('status', 'published').single();
        if (fixError) {
